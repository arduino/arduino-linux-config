...
func TestBuildFdtoverlayCommand(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name:        "empty overlays",
			overlays:    []string{},
			wantCommand: "/usr/bin/fdtoverlay -i /boot/efi/dtb/qcom/qrb2210-arduino-imola-base.dtb -o /boot/efi/dtb/qcom/temporaryDeviceTree.1777291200000000000.temp",
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			args, _ := UnoQ{}.buildOverlayCommand(overlaysDir, tt.overlays, fixedTime)
