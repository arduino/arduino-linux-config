...
// parts plugged into the board. A carrier and an addon use different connectors,
...
func NewHwCmd() *cobra.Command {
	...
	hwCmd := &cobra.Command{
		...
		Short:   "Manage the carriers and the addons connected to the board",
		Long:    "Manage the carriers and the addons connected to the board, including listing, configuring and resetting.",
	}
